...
testbed_fp = open(
    "/home/stack/jenkins/workspace/ubuntu-16-04_ocata_vcenter_compute_HA_Sanity_TEMP/contrail-tools/fabfile/testbeds/testbed.py","w+")
...
bm_vm_mapping = {
        "10.84.54.20": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":25, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.6": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":39, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.7": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":53, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.8": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":67, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.9": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":81, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.10": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":95, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.11": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":109, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.12": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":123, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.13": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":137, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.14": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":151, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.15": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":165, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.16": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":179, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.17": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":193, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.18": {"vm_count":14, "vm_ip_prefix":"10.84.54", "start_id":207, "vm_image":'centos-7.4.qcow2'},
        "10.84.54.19": {"vm_count":4, "vm_ip_prefix":"10.84.54", "start_id":221, "vm_image":'centos-7.4.qcow2'}
}
